...
func (s *Service) createFakeSnippets(ctx context.Context) error {
	snippets := []models.SnippetInput{
		...
		{
			Title:       "Arabic Markdown - مرحباً بكم",
			Description: "مثال على دعم اللغة العربية والكتابة من اليمين لليسار في Snipo",
			Language:    "markdown",
			Content:     "# مرحباً بكم في Snipo\n\nهذا مثال على دعم اللغة العربية والكتابة من اليمين لليسار (RTL).\n\n## الميزات\n\n- **إدارة الأكواد**: حفظ وتنظيم مقتطفات الكود\n- **دعم متعدد اللغات**: JavaScript, Python, Go والمزيد\n- **المزامنة مع GitHub**: مزامنة مقتطفاتك مع GitHub Gist\n- **الوضع الداكن**: واجهة مستخدم مريحة للعين\n\n## مثال على كود JavaScript\n\n```javascript\nfunction sayHello(name) {\n    console.log(`مرحباً ${name}!`);\n    return `أهلاً وسهلاً بك في Snipo`;\n}\n\nsayHello(\"المستخدم\");\n```\n\n## مثال على كود Python\n\n```python\ndef greet_user(name):\n    \"\"\"دالة للترحيب بالمستخدم\"\"\"\n    print(f\"مرحباً {name}!\")\n    return f\"أهلاً وسهلاً بك في Snipo\"\n\ngreet_user(\"المستخدم\")\n```\n\n## تنسيقات النصوص\n\nيمكنك استخدام **النص العريض** و *النص المائل* و `النص البرمجي`.\n\n### القوائم\n\n1. العنصر الأول\n2. العنصر الثاني\n3. العنصر الثالث\n\n### الاقتباسات\n\n> هذا مثال على اقتباس في النص العربي.\n> Snipo هو أفضل أداة لإدارة مقتطفات الكود!\n\n### الجداول\n\n| الميزة | الوصف |\n|--------|-------|\n| السرعة | أداء سريع جداً |\n| الأمان | تشفير كامل للبيانات |\n| السهولة | واجهة مستخدم بسيطة |\n\n## روابط مفيدة\n\n- [الموقع الرسمي](https://snipo.app)\n- [الوثائق](https://docs.snipo.app)\n- [GitHub](https://github.com/snipo)\n\n---\n\n**ملاحظة**: Snipo يدعم بشكل كامل اللغة العربية و RTL!",
			Tags:        []string{"arabic", "rtl", "markdown", "demo"},
		},
	}

...
- **[Features Guide](docs/features.md)**: In-depth guide to Search, Public Snippets, Gist Sync, API, and Arabic/RTL support.
- **[Security](SECURITY.md)**: Security model, authentication modes, and best practices.
- **[Customization](docs/customization.md)**: Theming, custom CSS, and RTL customization guide.
